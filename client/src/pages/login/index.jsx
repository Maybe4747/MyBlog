        ...
        <div className="backdrop-blur-xl bg-white/10 rounded-3xl shadow-2xl border border-white/20 p-8 transform transition-all duration-500 hover:bg-white/15 hover:shadow-[0_0_50px_rgba(0,221,255,0.3)]">
          ...
          <div className="mt-8">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button className="w-full px-4 py-3 border border-white/10 rounded-2xl text-white/70 font-medium hover:bg-white/5 transition-all duration-200 flex items-center justify-center">
